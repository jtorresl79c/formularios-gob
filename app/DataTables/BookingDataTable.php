...
class BookingDataTable extends DataTable
{
        ...
        return datatables()
            ...
            ->editColumn('created_at', function ($request) {
                ...
                if ($row->business_logo) {
                    if (File::exists(Storage::path($row->business_logo))) {
                ...
                $booking_slots = str_replace("_", " ", $row->booking_slots);
                return strtoupper($booking_slots);
            })
 ...
 public function html(): HtmlBuilder
    ...
    var select = $(table.api().table().container()).find(".dataTables_length select").removeClass(\'custom-select custom-select-sm form-control form-control-sm\').addClass(\'dataTable-selector\');
        ...
        $canCreateBooking = \Auth::user()->can('create-booking');
        $canExportBooking = \Auth::user()->can('export-booking');
        $buttonsConfig = [];
        ...
        if ($canCreateBooking) {
            $buttonsConfig[] = [
                ...
                'action' => " function (e, dt, node, config) { window.location = '" . route('bookings.create') . "'; }",
            ];
        }
        $exportButtonConfig = [];
