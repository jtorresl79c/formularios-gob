                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 paymenttype {{ $form->payment_status == '1' ? 'd-block' : 'd-none' }}">
                                <div class="form-group">
                                    ...
                                    {!! Form::select('payment_type', $payment_type,  $form->payment_type, ['class' => 'form-control', 'data-trigger']) !!}
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <p class="text-sm">{{ __('The name of currency is to be taken frome this document.') }}
