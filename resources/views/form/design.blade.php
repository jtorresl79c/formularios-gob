...
@section('breadcrumb')
    <div class="col-md-12">
        <div class="page-header-title">
            <h4 class="m-b-10">{{ __('Formulario de diseño') }}</h4>
        </div>
        <ul class="breadcrumb">
            <li class="breadcrumb-item">{!! Html::link(route('home'), __('Dashboard'), []) !!}</li>
            <li class="breadcrumb-item">{!! Html::link(route('forms.index'), __('Formulario'), []) !!}</li>
            <li class="breadcrumb-item active"> {{ __('Formulario de diseño') }} </li>
        </ul>
    </div>
@endsection
@section('content')
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <ul id="tabs"
                                                        ...
                                                        @else
                                                            <li>
                                                                {!! Html::link('#page-1', __('Pagina 1'), []) !!}
                                                            </li>
                                                        @endif
                                                        <li id="add-page-tab">
                                                            {!! Html::link('#new-page', __('+Pagina'), [
                                                                'class' => 'nav-link',
                                                            ]) !!}
                                                        </li>
                                                    </ul>
                                                    ...
                                                    <div class="action-buttons">
                                                        ...
                                                        {!! Form::button(__('Actualizar'), ['class' => 'btn btn-primary', 'id' => 'getJSON']) !!}
                                                        {!! Form::button(__('Back'), [
                                                            'class' => 'd-none',
