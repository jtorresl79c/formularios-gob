                ...
                <div class="card-body">
                    ...
                    <div class="uploaded-pics gy-3 row">
                        <div
                            ...
                            <div class="theme-view-inner theme-view-hover">
                                <div class="theme-view-img">
                                    <img data-id="theme1" src="{{ Storage::url('form-themes/theme1/theme1.png') }}">
                                </div>
                        ...
                        <div
                            ...
                            <div class="theme-view-inner theme-view-hover">
                                <div class="theme-view-img">
                                    <img data-id="theme2" src="{{ Storage::url('form-themes/theme2/theme2.jpg') }}">
                                </div>
                                <div class="theme-overlay"></div>
                                <div class="theme-button"><button
                        ...
                        <div
                            ...
                            <div class="theme-view-inner theme-view-hover">
                                <div class="theme-view-img">
                                    <img data-id="theme3" src="{{ Storage::url('form-themes/theme3/theme3.jpg') }}">
                                </div>
                                <div class="theme-overlay"></div>
                        ...
                        <div
                            ...
                            <div class="theme-view-inner theme-view-hover">
                                <div class="theme-view-img">
                                    <img data-id="theme4" src="{{ Storage::url('form-themes/theme4/theme4.png') }}">
                                </div>
                                <div class="theme-overlay"></div>
                                <div class="theme-button"><button
                        ...
                        <div
                            ...
                            <div class="theme-view-inner theme-view-hover">
                                <div class="theme-view-img">
                                    <img data-id="theme5" src="{{ Storage::url('form-themes/theme5/theme5.png') }}">
                                </div>
                                <div class="theme-overlay"></div>
                                <div class="theme-button"><button
                        ...
                        <div
                            ...
                            <div class="theme-view-inner theme-view-hover">
                                <div class="theme-view-img">
                                    <img data-id="theme6" src="{{ Storage::url('form-themes/theme6/theme6.png') }}">
                                </div>
                                <div class="theme-overlay"></div>
                                <div class="theme-button"><button
                        ...
                        <div
                            ...
                            <div class="theme-view-inner theme-view-hover">
                                <div class="theme-view-img">
                                    <img data-id="theme7" src="{{ Storage::url('form-themes/theme7/theme7.jpg') }}">
                                </div>
                                <div class="theme-overlay"></div>
                                <div class="theme-button"><button
                        ...
                        <div
                            ...
                            <div class="theme-view-inner theme-view-hover">
                                <div class="theme-view-img">
                                    <img data-id="theme8" src="{{ Storage::url('form-themes/theme8/theme8.jpg') }}">
                                </div>
                                <div class="theme-overlay"></div>
                                <div class="theme-button"><button
