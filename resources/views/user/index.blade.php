  ...
  <div class="row mb-4">
    <div class="col">
        <div class="d-flex align-items-center justify-content-between">
            ...
            @can('usuarios.index')
            <a href="{{ route('usuarios.create') }}" class="btn btn-primary"></i>Agregar</a>
            @endcan
            ...
            <tr>
              ...
              <td>
                <div class="d-flex align-items-center">
                    <a class="btn btn-info me-1" href="{{ route('usuarios.edit', $usr->id) }}"
                        title="Editar">
                        <i class="bi bi-pencil-square"></i>
                        Editar
                    </a>
                    <form method="POST" class="m-0" action="{{ route('usuarios.destroy', $usr->id) }}">
                        @csrf
